...
/*
    ...
    一定有集合A > 集合B。需要找到的结果是火车站级数最少，等价于求最小值，等价于差分约束的最长路
    最长路中，最后A > B，操作之前有A < B,需要连一条从B->A的边。因为最坏情况下，A和B集合的大小都是500
...
const int INF = 0x3f3f3f3f, N = 2010, M = 1e6 + 10; // 点多+m个，边每个最多500 + 500，一共1000次最多
